      ...
      <Container className="max-w-6xl px-4 md:px-6">
        <div className="flex flex-col items-start gap-8 md:flex-row md:items-center md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            {/* Name */}
            <h1 className="hero-name text-3xl font-light text-gray-700 dark:text-gray-50 md:text-4xl lg:text-5xl">
              {heroData.name}
            </h1>

            {/* Tagline */}
            <p className="hero-tagline max-w-xl text-lg text-gray-500 dark:text-gray-300 md:text-xl">
              {heroData.tagline}
            </p>
            ...
            <div className="hero-social flex gap-4">
              {socialLinks.map(link => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 text-gray-500 transition-colors hover:border-gray-800 hover:bg-gray-800 hover:text-white dark:border-gray-700 dark:text-gray-400 dark:hover:border-gray-500 dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  {link.icon}
                </a>
              ))}
