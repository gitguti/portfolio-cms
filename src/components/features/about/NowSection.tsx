      ...
      <Container className="max-w-6xl px-4 md:px-6">
        <div className="space-y-4">
          ...
          <div className="now-item space-y-2">
            <h2 className="text-2xl font-bold text-gray-700 dark:text-gray-50 md:text-3xl">Now</h2>
          ...
          <div className="now-item space-y-3">
            <h3 className="font-medium text-gray-700 dark:text-gray-200">Currently exploring</h3>
            <ul className="space-y-2">
              {nowData.learning.map((item, index) => (
                <li
                  key={index}
                  className="flex items-start text-base leading-relaxed text-gray-700 dark:text-gray-300"
                >
